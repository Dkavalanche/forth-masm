...
; Archivo : forth_entrega.asm
; Estado  : versión funcional de trabajo
;
; Incluye:
;   - Consola interactiva
;   - Parser por tokens
;   - Diccionario estático + definiciones dinámicas mínimas (: ;)
;   - Stack de datos
...
;
; Notas:
;   - El input se normaliza a minúsculas
;   - Las definiciones con : ; están implementadas en una primera versión mínima
;   - Próxima etapa prevista: constant, variable, @, !
; =========================================================
